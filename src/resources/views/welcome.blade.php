...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>.header{background:#fff;padding:10px 20px;display:flex;justify-content:space-between;align-items:center;width:100%;box-sizing:border-box}.header .title{font-weight:bold;color:#1a202c;font-size:24px;margin-left:20px}.header .nav{display:flex;gap:1em;margin-right:20px}.header .nav a{color:#1a202c;text-decoration:none}</style>
        <!-- Styles -->
        <style>
